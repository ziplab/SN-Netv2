...
class BEiTAttention(BaseModule):
    ...
    def __init__(self,
        ...
        # self.inner_attn = FlashAttention(attention_dropout=attn_drop_rate)
...
class DeiT3(BaseModule):
    ...
    def __init__(self,
                 ...
                 is_anchor=False,
                 init_cfg=None):
        super(DeiT3, self).__init__(init_cfg=init_cfg)
    ...
    def forward_patch_embed(self, inputs):
        B = inputs.shape[0]
